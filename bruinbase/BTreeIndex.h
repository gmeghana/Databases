...
class BTreeIndex {
 public:
  ...
  RC helper(int& key, const RecordId& rid, int& new_key, PageId& new_pid, PageId curr_pid, int height);
 ...
 private:
  ...
  PageId prev;        ///memory of last page read 
  BTLeafNode memNode; ///optimizing read forward
