...
class BTLeafNode {
  public:
        BTLeafNode();
        static const int offset = sizeof(int);    // offset because beginning of buffer holds number of keys for node
...
class BTNonLeafNode {
  public:
    BTNonLeafNode();
    static const int offset = sizeof(int);    // offset because beggining of buffer holds number of keys in node
